...
Dette eksempel har været benyttet ved forelæsningen d. 5/10-2020. Formålet med eksemplet er at illustrere
...
På den sidste del af forelæsningsslides til 5/10-2020 regnes på et datasæt, hvor de husdyrvidenskabstuderende er fjernet. Her genfittes den additive model for tosidet ANOVA (dvs. modellen uden vekselvirkning) alene baseret på de resterende data (dvs. uden HV studerende).
...
plot(fitted(twoway.int), rstandard(twoway.int), pch = 16, main = "Tosidet ANOVA uden vekselvirkning", cex.main = 1.5, cex.lab = 1.5)
abline(h = 0, lty = 2)
