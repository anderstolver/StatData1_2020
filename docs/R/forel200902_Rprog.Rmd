...
For hvert gang kropsvægten øges med 1 kg, så vil vi forvente, at hjertevægten forøges med 4.0341 g i gennemsnit.
...
Datasættet `antibio` beskrevet på dagens forelæsningsslides (4/9-2019) indeholder målinger af mængden af organisk materiale (`org`) i gødning fra 36 kvier, som er inddelt i seks grupper (`type`). Grupperne angiver hvilken type antibiotikum, som har været tilsat til kviernes foder. Gruppen `type = Control` angiver, at der ikke har været tilsat antibiotikum til foderet.
